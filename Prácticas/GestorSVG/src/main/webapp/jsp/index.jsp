...
<body>
	<header>
		<h1>Gestor de imagenes SVG en  base de datos eXist</h1>
	...
	<section>
	 <table><tr>
        <td style="width:150px; background-color:#a7abad"><h4>Mostrar las im�genes SVG de una coleccion</h4></td>
		<td style="width:600px">
			<form id="LeerRecursos" method="GET" action="/GestorSVG/apiLR">
				<table><tr>
					<td>Introducir nombre de la coleccion:</td>
	...
	<section>
	 <table><tr>
	 	<td style="width:150px; background-color:#a7abad"><h4>Crear una nueva coleccion de imagenes SVG</h4></td>
		<td style="width:600px">
		...
		<td style="width:600px">
			<form id="ImagenNueva" method="GET" action="/GestorSVG/apiNI">
				<table><tr>
					...
					<td>Coleccion destino de la imagen</td>
					<td><input required name="collection"></td>
				</tr></table>
   ...
   <script>
	...
	<section>
	 <table><tr>
	 	<td style="width:150px; background-color:#a7abad"><h4>Borrar una coleccion de imagenes SVG</h4></td>
		<td style="width:600px">
			...
			<hr>
			<button form="BorrarColeccion">Borrar coleccion</button>
			</form>
		</td>
	</tr></table>
	</section>
	...
	<footer><h5>Sistemas Web - Escuela Ingenieria de Bilbao - EHU</h5></footer>
</body>
</html>